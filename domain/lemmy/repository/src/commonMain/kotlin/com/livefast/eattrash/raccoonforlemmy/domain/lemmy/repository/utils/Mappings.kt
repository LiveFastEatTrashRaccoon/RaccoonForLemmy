...
internal fun ListingType.toDto() =
    when (this) {
        ListingType.All -> All
...
internal fun com.livefast.eattrash.raccoonforlemmy.core.api.dto.ListingType.toModel(): ListingType =
    when (this) {
        All -> ListingType.All
...
internal fun com.livefast.eattrash.raccoonforlemmy.core.api.dto.SortType.toModel(): SortType? =
    when (this) {
...
internal fun SortType.toCommentDto(): CommentSortType =
    when (this) {
...
internal fun SearchResultType.toDto(): SearchType =
    when (this) {
...
internal fun CommentView.toModel() =
...
internal fun CommentReplyView.toModel() =
    PersonMentionModel(
        id = commentReply.id,
...
internal fun PrivateMessageView.toModel() =
    PrivateMessageModel(
...
internal fun PostReportView.toModel() =
    PostReportModel(
        id = postReport.id,
        postId = post.id,
...
internal fun CommentReportView.toModel() =
    CommentReportModel(
        id = commentReport.id,
...
internal fun SiteMetadata.toModel() =
    MetadataModel(
        title = title.orEmpty(),
        description = description.orEmpty(),
    )

internal fun ModlogItemType.toDto(): ModlogActionType =
    when (this) {
...
internal fun ModAddCommunityView.toDto() =
    ModlogItem.ModAddCommunity(
...
internal fun AdminPurgeCommunityView.toDto() =
    ModlogItem.AdminPurgeCommunity(
        id = adminPurgeCommunity.id,
        date = adminPurgeCommunity.date,
        admin = admin?.toModel(),
    )

internal fun AdminPurgeCommentView.toDto() =
    ModlogItem.AdminPurgeComment(
...
internal fun AdminPurgePersonView.toDto() =
    ModlogItem.AdminPurgePerson(
        id = adminPurgePerson.id,
        date = adminPurgePerson.date,
        admin = admin?.toModel(),
    )

internal fun AdminPurgePostView.toDto() =
    ModlogItem.AdminPurgePost(
        id = adminPurgePost.id,
        date = adminPurgePost.date,
        admin = admin?.toModel(),
    )

internal fun ModBanView.toDto() =
    ModlogItem.ModBan(
        id = modBan.id,
        date = modBan.date,
...
internal fun ModHideCommunityView.toDto() =
    ModlogItem.HideCommunity(
...
internal fun ModRemoveCommunityView.toDto() =
    ModlogItem.RemoveCommunity(
...
internal fun ModBanFromCommunityView.toDto() =
    ModlogItem.ModBanFromCommunity(
...
internal fun ModFeaturePostView.toDto() =
    ModlogItem.ModFeaturePost(
...
internal fun ModLockPostView.toDto() =
    ModlogItem.ModLockPost(
        id = modLockPost.id,
...
internal fun ModRemovePostView.toDto() =
    ModlogItem.ModRemovePost(
        id = modRemovePost.id,
...
internal fun ModRemoveCommentView.toDto() =
    ModlogItem.ModRemoveComment(
...
internal fun ModTransferCommunityView.toDto() =
    ModlogItem.ModTransferCommunity(
...
internal fun LocalUser.toModel() =
...
internal fun AccountSettingsModel.toDto() =
