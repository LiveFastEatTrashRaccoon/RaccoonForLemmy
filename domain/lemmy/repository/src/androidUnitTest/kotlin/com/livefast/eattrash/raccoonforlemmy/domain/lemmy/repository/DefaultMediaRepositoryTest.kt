...
class DefaultMediaRepositoryTest {
    ...
    @Test
    fun whenUploadImage_thenInteractionsAreAsExpected() = runTest {
        coEvery {
    ...
    @Test
    fun givenError_whenUploadImage_thenInteractionsAreAsExpected() = runTest {
        coEvery {
            postServiceV3.uploadImage(
                authHeader = any(),
                url = any(),
    ...
    @Test
    fun givenError_whenGetAll_thenResultAndInteractionsAreAsExpected() = runTest {
        coEvery {
            userServiceV3.listMedia(
                authHeader = any(),
                page = any(),
