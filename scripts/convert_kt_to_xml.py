...
def main():
    ...
    if lang_code == "en" and len(country_code) == 0:
        source_file = "../core/l10n/src/commonMain/kotlin/com/livefast.eattrash/raccoonforlemmy/core/l10n/messages/DefaultStrings.kt"
    else:
        source_file = "../core/l10n/src/commonMain/kotlin/com/livefast.eattrash/raccoonforlemmy/core/l10n/messages/{0}{1}Strings.kt".format(lang_code.capitalize(), country_code.capitalize())
