...
class FilteredContentsScreen(private val type: Int) : Screen {
    @OptIn(ExperimentalMaterial3Api::class)
    @Composable
    override fun Content() {
        val model: FilteredContentsMviModel =
            getViewModel<FilteredContentsViewModel>(FilteredContentsMviModelParams(type))
