...
@Composable
fun InboxMentionsScreen(modifier: Modifier = Modifier) {
    val model: InboxMentionsMviModel = getViewModel<InboxMentionsViewModel>()
                        ...
                        ActionOnSwipe.ToggleRead ->
                            SwipeAction(
                                swipeContent = {
                                    val icon =
                                        when {
                                            mention.read -> LocalResources.current.markChatUnread
