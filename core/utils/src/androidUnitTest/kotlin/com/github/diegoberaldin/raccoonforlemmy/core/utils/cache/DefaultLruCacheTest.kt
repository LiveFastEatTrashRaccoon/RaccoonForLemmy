...
class DefaultLruCacheTest {
    ...
    @Test
    fun givenNotExistingKey_whenGet_thenResultIsAsExpected() =
        runTest {
            val res = sut.get(1)
    ...
    @Test
    fun givenExistingKey_whenGet_thenResultIsAsExpected() =
        runTest {
    ...
    @Test
    fun givenSizeExceeded_whenGet_thenResultIsAsExpected() =
        runTest {
