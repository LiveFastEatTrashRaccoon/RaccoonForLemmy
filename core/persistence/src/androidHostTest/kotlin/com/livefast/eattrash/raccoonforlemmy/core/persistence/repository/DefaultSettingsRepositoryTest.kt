...
class DefaultSettingsRepositoryTest {
    ...
    @Test
    fun whenChangeCurrentBottomBarSections_thenValueIsUpdated() = runTest {
    ...
    @Test
    fun whenCreate_thenResultIsAsExpected() = runTest {
        ...
        verify {
            dao.create(
                ...
                defaultCommentSortTypeProfile = model.defaultCommentSortTypeProfile.toLong(),
    ...
    @Test
    fun givenLoggedUser_whenUpdate_thenResultIsAsExpected() = runTest {
        val model = SettingsModel(defaultListingType = 1)
    ...
    @Test
    fun givenAnonymousUser_whenUpdate_thenResultIsAsExpected() = runTest {
        val model =
            SettingsModel(
                theme = 1,
    ...
    private fun createFake(
        ...
        defaultCommentSortTypeProfile: Long = 3,
        ...
        defaultCommentSortTypeProfile = defaultCommentSortTypeProfile,
