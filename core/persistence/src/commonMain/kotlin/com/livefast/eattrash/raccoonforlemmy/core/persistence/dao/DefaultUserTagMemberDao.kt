...
internal class DefaultUserTagMemberDao(private val queries: UsertagmembersQueries) : UserTagMemberDao {
    override fun getBy(username: String, accountId: Long?): Query<GetBy> = queries.getBy(username, accountId)

    override fun getMembers(tagId: Long?): Query<UserTagMemberEntity> = queries.getMembers(tagId)
