...
data class LocalSite(
    ...
    @SerialName("default_comment_sort_type") val defaultCommentSortType: CommentSortType? = null,
    @SerialName("default_post_sort_type") val defaultPostSortType: SortType? = null,
